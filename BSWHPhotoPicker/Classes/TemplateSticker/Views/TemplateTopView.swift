...
class TemplateTopView: SuperView {
    ...
    private lazy var saveBtn = UILabel().text(BSWHPhotoPickerLocalization.shared.localized("save")).backgroundColor(kkColorFromHex("A216FF")).color(.white).centerAligned().hnFont(size: 14.h, weight: .boldBSBase).cornerRadius(8.h).onTap { [self] in
